...
export default function VA1Page() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-12 text-gray-900 font-sans">
      ...
      {/* Plain-English value section */}
      <div className="mb-8 grid md:grid-cols-3 gap-4">
        <div className="p-5 bg-gray-900 rounded-xl text-white">
          <div className="text-2xl mb-2">📋</div>
          <h3 className="font-bold text-sm mb-1">What this is</h3>
          <p className="text-gray-400 text-sm leading-relaxed">A complete breakdown of a federal IT services RFP — the kind your team would spend 2–3 days reading before writing a single word of your proposal.</p>
        </div>
        <div className="p-5 bg-gray-900 rounded-xl text-white">
          <div className="text-2xl mb-2">⚡</div>
          <h3 className="font-bold text-sm mb-1">What we did</h3>
          <p className="text-gray-400 text-sm leading-relaxed">We read the solicitation, mapped every compliance requirement, structured the proposal response, and identified the win themes that evaluators score highest.</p>
        </div>
        <div className="p-5 bg-gray-900 rounded-xl text-white">
          <div className="text-2xl mb-2">💰</div>
          <h3 className="font-bold text-sm mb-1">What it means for you</h3>
          <p className="text-gray-400 text-sm leading-relaxed">You start with a roadmap instead of a blank page. That’s the difference between a 60-hour proposal grind and a focused 20-hour effort — on a contract worth 100x the cost of this analysis.</p>
        </div>
      </div>
